<div
    class="w-full"
    x-data
    x-on:step-changed.window="window.scrollTo({ top: 0, behavior: 'smooth' })"
>
    <x-card class="w-3xl mx-auto">

        <x-card-header label="Modifica pratica" />

        <form
            wire:submit.prevent="savePractice"
            class="w-2xl mx-auto mt-10 mb-5"
        >
            {{-- Step labels --}}
    ...
    >
        ...
        <form
            wire:submit.prevent="saveCustomer"
        ...
        >
            @include('partials.customer.customer-form-fields', [
                ...
                'setTeamMemberFunction' => 'setNewCustomerTeamMember',
            ])
            ...
            <div class="flex items-center justify-end gap-x-3 mt-18">
                ...
                <flux:button
                    ...
                    type="button"
                    size="sm"
                    wire:click="closeCreateCustomerModal"
                    class="px-10 bg-gray-custom-2 border-gray-custom-2 text-gray-custom-5 hover:bg-gray-custom-3-hover hover:border-gray-custom-3-hover hover:text-white"
                >
                    Annulla
                </flux:button>
