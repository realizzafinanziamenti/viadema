<div>
        ...
        window.WireChatModal = () => {
            return {
                ...
                closeModalOnEscape(trigger) {
                    ...
                    if (trigger.modalType != 'WireChatModal') {
                        return;
                    }
    ...
    <div x-data="WireChatModal()" x-on:close.stop="setShowPropertyTo(false)"
        x-on:keydown.escape.stop="closeModalOnEscape({modalType: 'WireChatModal', event: $event })" tabindex="0"
        ...
        <div class="flex items-end  justify-center min-h-screen px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            <div x-show="show" x-on:click="closeModalOnClickAway()" x-transition:enter="ease-out duration-300"
                ...
                <div class="absolute inset-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] opacity-75">
                </div>
            </div>

            <span class="hidden sm:inline-block sm:align-middle sm:h-screen " inert hidden>&#8203;</span>

            <div x-show="show && showActiveModalComponent" x-transition:enter="ease-out duration-300"
