<div
    ...
    <header class=" sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] z-10 p-2">
        <div class="flex items-center pb-2">
            ...
            <h3 class="text-sm mx-auto font-semibold "><span>{{ __('wirechat::chat.group.add_members.heading.label') }}
                </span> {{ $newTotalCount }} / {{ $maxGroupMembers }}</h3>

            <flux:button size="sm" type="button" wire:click="save" wire:loading.attr="disabled" wire:target='save'
                class="p-2 disabled:cursor-not-allowed  ml-0 text-white! bg-azure-custom! border-azure-custom! hover:bg-azure-custom-hover! hover:border-azure-custom-hover!">
      ...
      "
        ...
        <section
            ...
            <flux:input type="search" id="users-search-field" wire:model.live.debounce='search' autocomplete="off"
          ...
          "
                ...
                @if ($selectedMembers)
                    ...
                    @foreach ($selectedMembers as $key => $member)
                        <li class="flex items-center text-nowrap min-w-fit px-2 py-1 text-[13px] font-medium text-gray-800 bg-[var(--wc-light-secondary)] rounded-sm dark:bg-[var(--wc-dark-secondary)] dark:text-gray-300"
                                ...
                                <div class="ml-auto">
                                    @if (
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-plus-square-fill w-6 h-6 text-green-500"
                                            viewBox="0 0 16 16">
                                            <path
