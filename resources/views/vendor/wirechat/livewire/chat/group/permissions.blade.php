<div class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]   opaticy-100 text-sm  min-h-screen w-full">
    <section
        class="flex gap-4 z-10 items-center p-5 sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]   ">
            ...
            <ul class="space-y-2">
                ...
                <li class="w-full flex  p-5">
                    ...
                    <span class="w-full text-start">
                        <h5 class="font-medium">
                            {{ __('wirechat::chat.group.permisssions.actions.edit_group_information.label') }}</h5>
                    ...
                    <span class="w-12">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input wire:model.live.debounce="allow_members_to_edit_group_info" type="checkbox"
                                class="sr-only peer">
                            <div
                                class="relative w-11 h-6  peer-focus:outline-hidden rounded-full peer
                ...
                <li class="w-full flex items-center p-5">
                    ...
                    <span class="w-12">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input wire:model.live.debounce="allow_members_to_send_messages" type="checkbox"
                                class="sr-only peer">
                            <div
                                class="relative w-11 h-6  peer-focus:outline-hidden rounded-full peer
                            bg-[var(--wc-light-secondary)]  dark:bg-[var(--wc-dark-secondary)]
                ...
                <li class="w-full flex items-center p-5">
                    <span class="w-12">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="size-6 w-6 h-6 text-gray-500 dark:text-white/90">
                            <path
                    ...
                    <span class="w-12">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input wire:model.live.debounce="allow_members_to_add_others" type="checkbox"
                                class="sr-only peer">
                            <div
                                class="relative w-11 h-6  peer-focus:outline-hidden rounded-full peer
                            bg-[var(--wc-light-secondary)]  dark:bg-[var(--wc-dark-secondary)]
