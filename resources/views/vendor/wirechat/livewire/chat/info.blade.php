<div id="info-modal" class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]   text-sm   h-full">
        ...
        <div class="flex  flex-col items-center gap-5 ">
            ...
            <div class=" grid  ">
                ...
                <a class="px-8 py-5 " @dusk="receiver_name" href="{{ $receiver?->profile_url }}">
                    <h5 class="text-xl">{{ $receiver?->display_name }}</h5>
                </a>
            </div>
    ...
    <section class="flex flex-col justify-start w-full">
        ...
        <button wire:confirm="{{ __('wirechat::chat.info.actions.delete_chat.confirmation_message') }}"
